...
public class Player extends DynamicGameObject {
	...
	public boolean collided(DynamicGameObject otherObject) {
		Circle ast = new Circle(otherObject.pos.x + otherObject.spriteWidth / 2,
				otherObject.pos.y + otherObject.spriteHeight / 2, otherObject.spriteWidth / 2);
